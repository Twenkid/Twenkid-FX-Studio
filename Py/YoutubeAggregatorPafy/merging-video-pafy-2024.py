...
def main():
    ...
    """
    urls = [r"C:\Redmi\26-3-2024\VID_20240326_134356.mp4",
r"C:\Redmi\26-3-2024\VID_20240326_132942.mp4",
r"C:\Redmi\26-3-2024\VID_20240326_133317.mp4",
r"C:\Redmi\26-3-2024\VID_20240326_133931.mp4"]
     """
    ...
    while True:
        ...
        if cv2.waitKey(10) & 0xFF == 27: #ESCAPE ord('e'):
            exit() #break
        print(timeit.default_timer() - start_time)
